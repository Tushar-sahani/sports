...
const Sports = () => {
  return (
    <div className="p-20 text-white box-border">
      <h1 className='text-xl font-bold after:content-[""] after:bg-[#738FFF] after:block after:h-[2px] after:w-16 pl-7'>
        Sports
      </h1>
      <div className="p-7 flex justify-center">
        {sportsData.map((data,id) => {
          return (
            <div key={data.id} className="bg-[#3B3E47] box-border w-60 p-3 ml-5">
        ...
        <div className="bg-[#3B3E47] box-border w-60 p-3 ml-5 relative">
          <span className="absolute bg-black w-12 text-center right-3 font-semibold">Ad</span>
